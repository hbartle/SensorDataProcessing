function [ h ] = drawbox( box_coordinates )
%Sets figure and draws a box demonstrating the smartphone
% Input argument:       box     Array containing 8 vectors to corner points
% Output argument:      h       Handle
...
cla;
h= fill3(x1,y1,z1,1,x2,y2,z2,3,x3,y3,z3,1,x4,y4,z4,1,x5,y5,z5,1,x6,y6,z6,1);
xlabel('X');
ylabel('Y');
zlabel('Z');
